...
sablono.util.ToString = (function (){var obj18382 = {};return obj18382;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7862__auto__ = x;if(and__7862__auto__)
...
{var x__8501__auto__ = (((x == null))?null:x);return (function (){var or__7874__auto__ = (sablono.util.to_str[goog.typeOf(x__8501__auto__)]);if(or__7874__auto__)
{return or__7874__auto__;
} else
{var or__7874__auto____$1 = (sablono.util.to_str["_"]);if(or__7874__auto____$1)
...
sablono.util.ToURI = (function (){var obj18384 = {};return obj18384;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7862__auto__ = x;if(and__7862__auto__)
...
{var x__8501__auto__ = (((x == null))?null:x);return (function (){var or__7874__auto__ = (sablono.util.to_uri[goog.typeOf(x__8501__auto__)]);if(or__7874__auto__)
{return or__7874__auto__;
} else
{var or__7874__auto____$1 = (sablono.util.to_uri["_"]);if(or__7874__auto____$1)
{return or__7874__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__18385){
var xs = cljs.core.seq(arglist__18385);
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__18386_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__18386_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__18386_SHARP_], null);
} else
{if(cljs.core.vector_QMARK_.call(null,p1__18386_SHARP_))
{return p1__18386_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__18387){
var maps = cljs.core.seq(arglist__18387);
...
*/
sablono.util.normalize_element = (function normalize_element(p__18388){var vec__18391 = p__18388;var tag = cljs.core.nth.call(null,vec__18391,0,null);var content = cljs.core.nthnext.call(null,vec__18391,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__18392 = cljs.core.re_matches.call(null,sablono.util.re_tag,cljs.core.name.call(null,tag));var _ = cljs.core.nth.call(null,vec__18392,0,null);var tag__$1 = cljs.core.nth.call(null,vec__18392,1,null);var id = cljs.core.nth.call(null,vec__18392,2,null);var class$ = cljs.core.nth.call(null,vec__18392,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"className","className",1004015509),(cljs.core.truth_(class$)?clojure.string.split.call(null,class$,/\./):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7874__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7874__auto__))
{return or__7874__auto__;
} else
