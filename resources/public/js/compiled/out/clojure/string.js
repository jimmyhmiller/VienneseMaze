...
{{
var G__16829 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16829;
continue;
}
} else
...
{var pred__16833 = cljs.core._EQ_;var expr__16834 = limit;if(cljs.core.truth_(pred__16833.call(null,1,expr__16834)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16833.call(null,2,expr__16834)))
...
var G__16836 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16837 = (limit__$1 - 1);
var G__16838 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16836;
limit__$1 = G__16837;
parts = G__16838;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16840 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16840))
{var replacement_16841 = temp__4090__auto___16840;buffer.append([cljs.core.str(replacement_16841)].join(''));
} else
{buffer.append(ch);
}
{
var G__16842 = (index + 1);
index = G__16842;
continue;
}
}
