...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16665 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16665 = (function (val,box,meta16666){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16665.cljs$lang$type = true;
cljs.core.async.impl.channels.t16665.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16665";
cljs.core.async.impl.channels.t16665.cljs$lang$ctorPrWriter = (function (this__8441__auto__,writer__8442__auto__,opt__8443__auto__){return cljs.core._write.call(null,writer__8442__auto__,"cljs.core.async.impl.channels/t16665");
});
cljs.core.async.impl.channels.t16665.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16665.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16667){var self__ = this;
var _16667__$1 = this;return self__.meta16666;
});
cljs.core.async.impl.channels.t16665.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16667,meta16666__$1){var self__ = this;
var _16667__$1 = this;return (new cljs.core.async.impl.channels.t16665(self__.val,self__.box,meta16666__$1));
});
cljs.core.async.impl.channels.__GT_t16665 = (function __GT_t16665(val__$1,box__$1,meta16666){return (new cljs.core.async.impl.channels.t16665(val__$1,box__$1,meta16666));
});
}
return (new cljs.core.async.impl.channels.t16665(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8444__auto__,writer__8445__auto__,opts__8446__auto__){return cljs.core._write.call(null,writer__8445__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8441__auto__,writer__8442__auto__,opt__8443__auto__){return cljs.core._write.call(null,writer__8442__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16668 = self__.takes.pop();if((taker_16668 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16668))
{var take_cb_16669 = cljs.core.async.impl.protocols.commit.call(null,taker_16668);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16669,taker_16668,this$__$1){
return (function (){return take_cb_16669.call(null,null);
});})(take_cb_16669,taker_16668,this$__$1))
);
} else
{}
{
