...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16659 = 0;while(true){
var m_16660 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16660 == null))
{} else
{m_16660.call(null);
if((count_16659 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16661 = (count_16659 + 1);
count_16659 = G__16661;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7862__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7862__auto__)
